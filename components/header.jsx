  ...
  import { View, Text, StatusBar, Image, TouchableOpacity, TextInput, Modal } from 'react-native';
  ...
  const Header = ({ navigation }) => {
    ...
    const [modalVisible, setModalVisible] = useState(false); // Modal visibility state for notification
